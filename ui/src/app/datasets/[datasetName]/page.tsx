  ...
  return (
    <>
      ...
      <TopBar>
        ...
        <div>
          <h1 className="text-lg">Dataset: {formatDatasetLabel(datasetName)}</h1>
          {formatDatasetLabel(datasetName) !== datasetName && (
            <p className="text-xs text-gray-500">Carpeta: {datasetName}</p>
          )}
        </div>
