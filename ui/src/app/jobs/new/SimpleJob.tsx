        ...
        <div className={topBarClass}>
          <Card title="Job">
            ...
            <SelectInput
              ...
              options={[
                ...gpuList.map((gpu: any) => ({ value: `${gpu.index}`, label: `GPU #${gpu.index} — ${gpu.name || 'Local'} (local)` })),
                { value: 'modal_L4', label: 'Modal · L4 24 GB (~$0.80/h)' },
                { value: 'modal_A10G', label: 'Modal · A10G 24 GB (~$1.10/h)' },
                { value: 'modal_A100-40GB', label: 'Modal · A100 40 GB (~$3.00/h)' },
                { value: 'modal_H100', label: 'Modal · H100 80 GB' },
              ]}
            />
            ...
            <TextInput
              ...
              onChange={(value: string | null) => {
                ...
                setJobConfig(value, 'config.process[0].training_folder');
              }}
              placeholder="eg. outputs/iter_01"
              required
            />
          </Card>
              ...
              <>
                ...
                <SelectInput
                  ...
                  onChange={(value: string) => {
                    setJobConfig(value === '' ? undefined : value, 'config.process[0].network.pretrained_lora_path');
                  }}
                  options={loraOptions.length > 1 ? loraOptions : [{ value: '', label: '\u2014 ninguno \u2014' }]}
                />
              </>
            )}
          </Card>
              ...
              <div>
                ...
                <SelectInput
                  ...
                  options={[
                    ...
                    { value: 'content', label: 'Content (High Noise)' },
                    { value: 'style', label: 'Style (Low Noise) ✦' },
                  ]}
                />
                <SelectInput
                  label="Loss Type"
