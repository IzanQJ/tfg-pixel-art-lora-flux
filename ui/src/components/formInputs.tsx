...
const inputClasses =
  'w-full text-sm px-3 py-1 bg-gray-800 border border-gray-700 rounded-sm text-gray-100 placeholder-gray-500 focus:ring-2 focus:ring-yellow-600/50 focus:border-transparent';
