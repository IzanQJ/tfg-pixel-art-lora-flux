...
export default function ConfirmModal() {
  ...
  const getButtonTextColor = () => {
    return color === 'info' ? 'text-black' : 'text-white';
  };
          ...
          >
            ...
            <div className="bg-gray-700 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                type="button"
                onClick={onConfirm}
                className={`inline-flex w-full justify-center rounded-md ${getButtonBgColor()} px-3 py-2 text-sm font-semibold ${getButtonTextColor()} shadow-xs sm:ml-3 sm:w-auto`}
              >
